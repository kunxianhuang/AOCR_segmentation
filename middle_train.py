...
#model = YOLO("runs/segment/train12/weights/best.pt") # load a begin trained model (only positive samples)


# Train the model from beginning
results = model.train(data='aocr.yaml', epochs=300, batch=48, imgsz=640)
